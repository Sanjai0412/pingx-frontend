...
import { likeTweet, unLikeTweet, quoteRetweet, retweetTweet, unRetweetTweet } from "../../services/tweetService";
...
const TweetActions = ({ tweet, onTweetCreated }) => {
    const { id, likeCount, likedByCurrentUser, retweetCount, retweetedByCurrentUser } = tweet;
    ...
    return <div className="tweet-actions">
        ...
        <button className={`tweet-action-btn retweet-btn ${retweeted ? "retweeted" : ""}`} onClick={() => setShowRetweetMenu(true)}>
