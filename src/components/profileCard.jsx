...
const ProfileCard = ({ profile, isOwnProfile }) => {
    const { username, displayName, profileImgUrl, bio, followingCount, followersCount } = profile;
            ...
            <div className="profile-header">
                <div className="profile-meta-top">
                    <div className="profile-avatar-wrapper">
                        {profileImgUrl ? (
                            <img className="profile-avatar-img" src={profileImgUrl} alt="Profile" />
                        ) : (
                ...
                <div className="profile-info">
                    ...
                    <div className="profile-stats-row">
                        <span className="profile-stat-item">
                            <strong className="profile-stat-count">{followingCount || 0}</strong> Following
                        </span>
                        <span className="profile-stat-item">
                            <strong className="profile-stat-count">{followersCount || 0}</strong> Followers
                        </span>
                    </div>
                </div>
            </div>
